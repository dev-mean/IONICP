...
var requestParams;
var options = {
	consumerKey: '3gjfCjbi7uoOtUZjrsvG469Mm',
	consumerSecret: 'gSglly8uDcIeTn5EXNIEcvpuu4oSwdGtiQvrqPIt4vGXpiw9GP',
	callbackUrl: "http://192.168.10.101:8100/oauthcallback.html"
};
...
var twitter = {
	...
	login: function() {
		...
		if(localStorage.getItem(twitterKey) !== null){
			...
			oauth = OAuth(options);
			oauth.get('https://api.twitter.com/oauth/request_token', function(data) {console.log(JSON.stringify(data));
